...
function makePlayer(seat: Seat, cfg: GameConfig['players'][number]): Player {
  ...
  return {
    ...
    scoredObjectives: [], secretObjectives: [],
    resourcesSpentThisRound: 0, influenceSpentThisRound: 0, tradeGoodsSpentThisRound: 0, tokensSpentThisRound: 0,
    spaceCombatWins: 0,
    inheritanceExhausted: false, productionBiomesExhausted: false, spatialConduitExhausted: false, transitDiodesExhausted: false, pendingInfantry: 0, reinforcements,
  }
}
